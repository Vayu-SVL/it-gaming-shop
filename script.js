...
function displayProducts() {
    ...
    if (filtered.length === 0) {
        grid.innerHTML = `<div class="no-results">🔍 ${t('ບໍ່ພົບສິນຄ້າທີ່ຄົ້ນຫາ')}</div>`;
        return;
    }
...
function renderCartModal() {
    ...
    modalBody.innerHTML = `
        ...
        <div class="cart-items-list">
            ${cart.length === 0
                ? `<div class="cart-empty">🛒 ${t('ຍັງບໍ່ມີສິນຄ້າ')}</div>`
                : cartItemsHtml}
        </div>

        ${cart.length > 0 ? `
            <h3 class="cart-section-title"><i class="fas fa-truck"></i> ${t('ບໍລິການຂົນສົ່ງ')}</h3>
            ...
            <h3 class="cart-section-title"><i class="fas fa-credit-card"></i> ${t('ຮູບແບບການຊຳລະ')}</h3>
            ...
            ${selectedPayment === 'qr' ? `
            <div id="qrPaySection" class="qr-pay-section">
                <p class="qr-pay-title">📲 ${t('ສະແກນ QR ເພື່ອຊຳລະ')}</p>
                <img src="data:image/png;base64,"
                     ...
                     class="qr-image">
                <p class="qr-caption">ສະແກນດ້ວຍ BCEL One, LDB Connect ຫຼື app ທະນາຄານ</p>
            </div>
            ` : ''}

            ${selectedPayment === 'card' ? `
            <div id="cardPaySection" class="card-pay-section">
                <p class="card-pay-title">💳 ${t('ປ້ອນຂໍ້ມູນບັດ')}</p>
                <input type="text" id="cardNumber" placeholder="0000 0000 0000 0000" maxlength="19"
                    oninput="this.value=this.value.replace(/[^0-9]/g,'').replace(/(.{4})/g,'$1 ').trim().substring(0,19)"
                    class="card-input card-number-input">
                ...
                <input type="text" id="cardName" placeholder="${t('ຊື່ເທິງບັດ')}"
                    class="card-input card-name-input">
                <p class="card-security-note">🔒 ຂໍ້ມູນຖືກເຂົ້າລະຫັດຢ່າງປອດໄພ</p>
            </div>
            ` : ''}
            ...
            <div class="coupon-section">
                ...
                <p id="couponMsg" class="coupon-msg${discountApplied ? ' discount-active' : ''}">
